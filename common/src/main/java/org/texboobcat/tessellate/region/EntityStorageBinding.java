...
import org.texboobcat.tessellate.mixin.accessor.PersistentEntitySectionManagerAccessor;
import org.texboobcat.tessellate.mixin.accessor.ServerLevelEntityManagerAccessor;
...
public final class EntityStorageBinding {
    ...
    public static RegionShardedEntityStorage<?> shardedStorageOf(ServerLevel level) {
        PersistentEntitySectionManager<?> manager =
            ((ServerLevelEntityManagerAccessor) level).tessellate$getEntityManager();
        EntitySectionStorage<?> storage =
            ((PersistentEntitySectionManagerAccessor) manager).tessellate$getSectionStorage();
    ...
    public static LevelCallback<Entity> callbacksOf(ServerLevel level) {
        ...
        return (LevelCallback<Entity>)
            ((PersistentEntitySectionManagerAccessor) manager).tessellate$getCallbacks();
    }
    ...
    public static void copyTickingChunks(ServerLevel level, LongSet target) {
        ...
        Long2ObjectMap<Visibility> visibility =
            ((PersistentEntitySectionManagerAccessor) manager).tessellate$getChunkVisibility();
