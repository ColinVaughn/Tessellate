...
import org.texboobcat.tessellate.mixin.accessor.WalkNodeEvaluatorInvoker;
...
public final class ConcurrentPathTypeCache extends PathTypeCache {
    ...
    public PathType getOrCompute(BlockGetter level, BlockPos pos) {
        ...
        PathType computed = WalkNodeEvaluatorInvoker.tessellate$getPathTypeFromState(level, pos);
