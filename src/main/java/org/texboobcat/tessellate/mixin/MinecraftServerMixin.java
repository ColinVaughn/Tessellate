...
public abstract class MinecraftServerMixin {
    ...
    private boolean tessellate$runSaveBoundary(boolean suppressLogs, boolean flush, boolean force,
    ...
    private void tessellate$runShutdownBoundary(Operation<Void> original) {
        if (Config.regionsEnabled && !RegionWorkers.isWorkerThread()) {
            ...
            TESSELLATE$LOGGER.info("tessellate: shutdown boundary complete; calls={}, main={} ms, "
