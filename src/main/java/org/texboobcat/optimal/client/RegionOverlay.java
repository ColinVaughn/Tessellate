package org.texboobcat.optimal.client;
...
import org.texboobcat.optimal.Optimal;
...
@EventBusSubscriber(modid = Optimal.MODID, value = Dist.CLIENT)
public final class RegionOverlay {
    ...
    private static void drawMap(GuiGraphics graphics, Minecraft minecraft,
        ...
        graphics.drawString(minecraft.font,
            "OPTIMAL  " + uniqueRegionCount(payload.cells()) + " REGIONS  |  "
